...
Version `0.1.0-alpha.12` is the current operator-deployable alpha. The GDD remains the long-term product contract; this document defines the release boundary and the evidence required to call one build releasable.
