...
> **Статус:** `0.1.0-alpha.12` — закрытая альфа с Ареной: дивизионы и сезоны, места Чемпиона и Заместителя, мана и ближний бой, история и повторы матчей, задания и серии. Гримуары переименовываются и правятся в одно касание. Производственные секреты хранятся вне репозитория.
