...
> **Статус:** `0.1.0-alpha.11` — закрытая альфа с Ареной: дивизионы и сезоны, места Чемпиона и Заместителя, мана и ближний бой, история и повторы матчей, задания и серии. Производственные секреты хранятся вне репозитория.
