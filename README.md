...
> **Статус:** `0.1.0-alpha.10` — закрытая альфа с отдельной Ареной, собственным рейтингом, настраиваемыми командными боями, событиями окружения и боевыми призывами. Производственные секреты хранятся вне репозитория.
