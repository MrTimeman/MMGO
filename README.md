...
> **Status:** `0.1.0-alpha.3` — closed alpha with Telegram authentication, production deployment automation, and a simplified player-facing interface. Production credentials remain outside the repository.
