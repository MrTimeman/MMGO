...
> **Статус:** `0.1.0-alpha.5` — закрытая альфа с Telegram-аутентификацией, восстановленным физическим интерфейсом и автоматизированным развёртыванием. Производственные секреты хранятся вне репозитория.
