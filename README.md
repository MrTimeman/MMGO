...
> **Статус:** `0.1.0-alpha.7` — закрытая альфа с Telegram-аутентификацией, глобальным режимом бета-дуэлей и школьными особенностями заклинаний. Производственные секреты хранятся вне репозитория.
